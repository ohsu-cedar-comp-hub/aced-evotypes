...
// STEP 1 - pileups. Do this for the normal and tumor bam
// Create channel for Pileups?
process GetPileupSummaries {
    ...
    output:
    path ("*${params.tumor_namepattern}*.pileup.table"), emit: tumor_pileup
    path ("*${params.normal_namepattern}*.pileup.table"), emit: normal_pileup

    script:
    """
    gatk GetPileupSummaries \
    --input ${bam} \
    --output ${bam_basename}.pileup.table \
    --variant ${small_exac} \
