...
params.release= "v0.1.3"
params.releasedate = "12-17-2024"
params.githublink = "https://github.com/ohsu-cedar-comp-hub/aced-evotypes/tree/v0.1.3/nextflow"
...
workflow {
    ...
    AlleleCounter("${params.scratch_root}/${params.number_var}/files", params.bin, params.g1000alleles, SampleID.out.normal_SM, SampleID.out.tumor_SM, SampleID.out.normal_file, SampleID.out.tumor_file)
}